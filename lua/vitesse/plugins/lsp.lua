return function(opts)
  ...
  Group.new("DiagnosticDeprecated", groups.Comment, colors.none, styles.italic + styles.undercurl)
  Group.new("DiagnosticUnderlineError", colors.none, colors.none, styles.undercurl)
